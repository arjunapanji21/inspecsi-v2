...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('data_assessments', function (Blueprint $table) {
            ...
            $table->enum('ket_sputum', ['Tidak Ada', 'Kental', 'Encer', 'Darah']);
            $table->enum('sesak_napas', ['Tidak', 'Ya']);
            $table->string('ket_sesak_napas')->nullable();
            $table->enum('alat_bantu_napas', ['Tidak', 'Ya']);
            ...
            $table->enum('keluhan_nyeri', ['Tidak', 'Ya']);
            ...
            $table->enum('kebutuhan_edukasi', ['Tidak Ada', 'Perawatan', 'Nutrisi', 'Manajemen Nyeri', 'Perawatan Luka', 'Pengobatan', 'Aktivitas dan Latihan', 'Pencegahan Infeksi', 'Lainnya']);
            ...
            $table->enum('assessment_populasi_khusus', ['Tidak Ada', 'Geriatrik', 'Kemoterapi', 'Hemodialisa', 'Terminal', 'Perioperatif', 'Lainnya']);
